...
def str2dataset(d):
    if d.upper() in ('A', 'B', 'C'):
        ...
        raise argparse.ArgumentTypeError('Valid dataset split expected (\'A\', \'B\', or \'C\')')
...
def get_args():
    ...
    parser.add_argument('--image_height', nargs="?", type=int, default=128, help='Height of image data')
    parser.add_argument('--image_width', nargs="?", type=int, default=128, help='Width of image data')
    ...
    parser.add_argument('--dataset', nargs="?", type=str2dataset, default="A")
