...
train_data = data_providers.LoTSSDataProvider('train', batch_size=args.batch_size, rng=rng, dataset=args.dataset)
rng.seed(args.seed)
val_data = data_providers.LoTSSDataProvider('valid', batch_size=args.batch_size, rng=rng, dataset=args.dataset)
rng.seed(args.seed)
test_data = data_providers.LoTSSDataProvider('test', batch_size=args.batch_size, rng=rng, dataset=args.dataset)
rng.seed(args.seed)
